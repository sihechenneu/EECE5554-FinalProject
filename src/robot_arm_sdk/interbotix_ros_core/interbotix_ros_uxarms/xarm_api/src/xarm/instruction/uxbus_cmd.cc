...
int UxbusCmd::check_xbus_prot(unsigned char *data, int funcode) { (void)data; (void)funcode; return -11; }

int UxbusCmd::send_pend(int funcode, int num, int timeout, unsigned char *rx_data) {
	(void)funcode; (void)num; (void)timeout; (void)rx_data;
	return -11;
}

int UxbusCmd::send_xbus(int funcode, unsigned char *txdata, int num) { (void)funcode; (void)txdata; (void)num; return -11; }
