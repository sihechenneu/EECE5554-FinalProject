"""
YOLO-based trash detector. Used by inference.py (CLI) and for single-frame use.
Expects numpy BGR image (H, W, 3); returns list of detections. No ROS2 dependency.
"""
...
DEFAULT_WEIGHTS = _WORKSPACE_ROOT / "runs" / "detect" / "taco_yolov8" / "weights" / "best.pt"
