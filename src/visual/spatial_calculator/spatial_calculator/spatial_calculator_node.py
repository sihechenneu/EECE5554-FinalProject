...
class SpatialCalculatorNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('info_topic', '/oakd/stereo/camera_info')
        self.declare_parameter('yolo_topic', '/yolo/detections')
        self.declare_parameter('yolo_type', 'Detection2DArray')
        self.declare_parameter('output_topic', '/yolo/spatial_detections')
        ...
        yolo_type = self.get_parameter('yolo_type').get_parameter_value().string_value
        ...
        elif yolo_type == 'Detection3DArray':
        ...
        self.get_logger().info('Spatial calculator started.')
    ...
    def yolo_cb(self, msg):
        ...
        for det in msg.yolov8_inference:
            ...
            boxes.append({
                ...
                'orig_cx': cx, 'orig_cy': cy,
                'orig_sx': x2 - x1, 'orig_sy': y2 - y1,
